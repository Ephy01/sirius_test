...
// Точечная сфера в духе знака Университета «Сириус»: крупные точки у
// смещённого влево ядра, мелкие к краю. Координаты сгенерированы
// детерминированно и заморожены.
