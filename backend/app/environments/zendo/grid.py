...
def generate_grid_zendo_task(
    *,
    ...
    public = {
        ...
        "prompt": (
            "Узоры на сетке 5×5 подчиняются скрытому правилу. Изучите два "
            "положительных и два отрицательных примера. Можно нарисовать и "
            "проверить до пяти собственных узоров, затем классифицируйте "
            "восемь целей по порядку."
        ),
        "cards": {
