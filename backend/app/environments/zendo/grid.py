...
def generate_grid_zendo_task(
    *,
    ...
    public = {
        ...
        "prompt": (
            "Рассмотрите предложенные узоры на сетке 5×5. Было загадано "
            "некоторое утверждение: одни узоры ему соответствуют, другие — "
            "нет. Предположите, что это за утверждение, и классифицируйте "
            "восемь целевых узоров по порядку. Перед ответом можно "
            "нарисовать и проверить собственные узоры — доступно 5 проб."
        ),
        "cards": {
