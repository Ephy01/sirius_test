...
def generate_point_zendo_task(
    *,
    ...
    public = {
        ...
        "prompt": (
            "Наборы точек на решётке подчиняются скрытому правилу. Изучите "
            "два положительных и два отрицательных примера. Можно проверить "
            "до пяти карточек, затем классифицируйте восемь целей по порядку."
        ),
