...
def generate_geo_zendo_task(
    *,
    ...
    public = _public_state(
        ...
        prompt=(
            "Фигуры подчиняются скрытому геометрическому правилу. "
            "Изучите положительные и отрицательные примеры. Можно проверить "
            "ограниченное число карточек, затем классифицируйте цели по порядку."
        ),
        scene=public_scene,
        content={
            "examples": [
